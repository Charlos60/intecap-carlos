# Generated by Django 4.2.5 on 2023-10-18 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.categoriacurso')),
            ],
            options={
                'verbose_name': 'Curso',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.curso')),
                ('id_estudiante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.estudiante')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_inscripcion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aplicacion.inscripcion')),
            ],
            options={
